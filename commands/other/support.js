...
module.exports = {
    ...
    async execute(interaction) {
        let embed = new EmbedBuilder()
            .setColor('DarkGreen')
            .setTitle('Support')
            .setDescription('This is a friendly message asking you to go to https://discord.com/channels/1089258451949064296/1268414349764989019 and describe your issue with:\n1. The behavior you are experiencing.\n2. The behavior you expect.\n3. Your exact steps to produce this behavior.\n4. Your troubleshooter file (as shown below).')
